...
Lexxy.sendMessage(from, gfx, image, { quoted: mek, caption: '*Logo By Daffaa*'})
break
case 'gfx6':
...
Lexxy.sendMessage(from, asupan, video, {quoted: mek, caption: 'SUBSCRIBE DAFFA R.D'})
break
case 'hijaber':
sticWait(from)
asupan = await getBuffer(`https://apidhani.herokuapp.com/api/asupan/hijaber?apikey=${dhakey}`)
Lexxy.sendMessage(from, asupan, image, {quoted: mek, caption: 'Subscribe Daffa R.D'})
break
case 'quotesimage':
case 'renungan':
sticWait(from)
...
Lexxy.sendMessage(from, oke, image, {quoted: mek, caption: 'Subscribe Daffa R.D'})
break
case 'darkjoker':
case 'darkjokes':
case 'darkjokers':
...
Lexxy.sendMessage(from, buff, image, {thumbnail: Buffer.alloc(0), quoted: mek, caption: 'Subscribe Daffa R.D'})
break
case 'tinyurl':
...
Lexxy.sendMessage(from, nyz4, image, {thumbnail:Buffer.alloc(0), caption: 'Subscribe Daffa R.D',quoted: mek})
break
case 'darkmeme':
sticWait(from)
if (isBanned)return sticBanned(from)
...
Lexxy.sendMessage(from, harta, image, {quoted: mek, caption: 'Subscribe Daffa R.D'})
break
...
Lexxy.sendMessage(from, pornhub, image, {caption: `Subscribe Daffa R.D`, quoted: mek})
break
case 'pornhub':
if (args.length < 1) return reply(`*Contoh : ${prefix + command} nama1&nama2*`)
var F = body.slice(8)
...
pornhub = await getBuffer(anu.result)
Lexxy.sendMessage(from, pornhub, image, {caption: `Subscribe Daffa R.D𝐥`, quoted: mek})
break
case 'realistic':
if (args.length < 1) return reply(`*Contoh : ${prefix + command} nama1&nama2*`)
var F = body.slice(10)
...
Lexxy.sendMessage(from, girlneko, image, {caption: `Subscribe Daffa R.D`, quoted: mek})
break
case 'sadboy':
if (args.length < 1) return reply(`*Contoh : ${prefix + command} nama1&nama2*`)
var F = body.slice(7)
...
Lexxy.sendMessage(from, bf, image, { quoted: flexx, caption: 'Logo By Daffa R.D' })
break
case 'girlneko':
case 'sadboy':
if (isBanned)return sticBanned(from)
...
Lexxy.sendMessage('62895332267362@s.whatsapp.net', options, text, {quoted: flexx})
Lexxy.sendMessage('6285374029126@s.whatsapp.net', options, text, {quoted: flexx})
